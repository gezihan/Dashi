...
public class YelpAPI {
    ...
    private static final String CONSUMER_KEY = "sGQy9qxPNvD3JcHtjMyy_Q";
    private static final String CONSUMER_SECRET = "662f-QXDYimiyzuVESoQGLYeAeI";
    private static final String TOKEN = "Ke28lmqxAkuZRAsYftJgcBomiLoSQaAx";
    private static final String TOKEN_SECRET = "bkz7ggvGXdtqwbSxELDatZ8Dfuk";
